...
class MLP(nn.Module):
    ...
    '''
    def __init__(self, hidden=128, sharing=False, verbose=True):
        '''
        Initialize the MLP
        ...
        hidden
            ...
            (Though not explicited in the report, we have not found much 
            difference when choosing the number of hidden neurons)
        verbose
